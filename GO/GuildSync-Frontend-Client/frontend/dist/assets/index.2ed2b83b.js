        ...
        <tbody>
          ${re.map(t=>{var e,n,r,i,o,s,a;return`
            <tr>
              ...
              <td style="text-align:right;">${c(Du((o=(i=t.deposit_amount)!=null?i:t.depositAmount)!=null?o:t.amount))} \u{1FA99}</td>
              <td style="text-align:right;">${c(Mu((a=(s=t.ticket_quantity)!=null?s:t.ticketQuantity)!=null?a:t.ticketAmount))}</td>
