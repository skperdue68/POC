    ...
    <main class="main-window">
      ...
      <section class="main-surface">
        ...
        <footer class="status-bar">
          ...
          <div id="serverStatusText" class="server-status-text">Server Unavailable</div>
